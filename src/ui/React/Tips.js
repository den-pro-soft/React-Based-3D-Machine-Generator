...
export default class Tips{
    ...
    constructor(){
        ...
        this.tips['select-tool'] = "Select</br>Chooses a line to which you want to issue a command or make a change.</br>" +
            " Click on the line. To select multiple lines hold the CTRL key.</br> To select connected lines hold the SHIFT key.";
        this.tips['line-tool'] = "Line</br> Draws a straight line. Click at the start and  end points. Hold the CTRL key </br>" +
            "while drawing for a precise 0, 15, 30 or 45 deg angle.</br> Press spacebar to restart line mode.";
        this.tips['spline-tool'] = "Spline</br>Draws a special style of curve.</br> In workarea click to specify start point of the curve.</br>" +
            " Click again at end point.</br> Drag the control points to modify  the curve.";
        ...
        this.tips['freehand-tool'] = "Freehand</br> Draws a freehand sketch.</br> Click and hold mouse button while moving the mouse.</br>" +
            "Use the Node edit tool to modify.";
        this.tips['eraser-tool'] = "Eraser</br> Use  this essential tool to create most shapes.</br> First draw overlapping circles, rectangles and straight lines." +
            "</br> Then click this Eraser tool and click on the appropriate line segments to be erased.</br>" +
            " For example, try creating a “D” shape by drawing a vertical line through a circle and </br>" +
            "then erasing the appropriate line segments. Or try drawing a thick ”+” shape by first drawing overlapping </br>" +
            "vertical and horizontal rectangles and then erasing the internal segments.";
        this.tips['corner-tool'] = "Corner</br> Rounds or chamfers sharp 2D corners.</br> First select two or more lines that meet.";
        this.tips['text-tool'] = "Text</br> Adds comment text to design.</br> In workarea, click to specify starting point. Type the text and press Enter.";
        this.tips['line-edit-tool'] = "Line Edit</br>Allows to move line endpoints to adjust a shape.</br> In workarea click on the line.</br>" +
        ...
        this.tips['numeric-repeat'] = "Repeat (Ctrl+D)</br>When this button is pressed in, </br>" +
            "the nudge arrow buttons and the nudge rotation buttons will create</br> copies of the selected shape.</br>" +
            " For example, to create 3 copies to the right of an existing shape,</br>" +
            "select the shape, press in this Repeat button and press the right arrow button or key 3 times.";
        ...
        this.tips['numeric-nudge-step'] = "Nudge step </br> The distance an object will move when an arrow button or key is pressed.</br>" +
            " It is generally recommended to move an item by first dragging</br> the item to a snap point on an existing line and then nudging.";
        ...
        this.tips['numeric-rotate-clockwise'] = "Rotate selected line Right (clockwise) </br>The state of the Repeat button determines</br>" +
            " if lines are duplicated or simply rotated.";
