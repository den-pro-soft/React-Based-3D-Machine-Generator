...
// import container from '../../2d/Board';
...
const LeftMenu = context => {
  ...
  // console.log(Board.setTool('Pointer'),'containerBoard');
  // onClick={()=>window.container.board.setTool('Line')}
  // onClick={()=>window.container.board.setTool('Rectangle')}
  return (
    <div className="LeftMenu">
      ...
      <button onClick={() => container.board.setTool("Line")}>
        <img
          width="25px"
          src="images/Line.png"
      ...
      <button onClick={() => container.board.setTool("Rectangle")}>
        <img
          width="25px"
      ...
      <button onClick={() => container.board.setTool("Circle")}>
        <img
          width="25px"
