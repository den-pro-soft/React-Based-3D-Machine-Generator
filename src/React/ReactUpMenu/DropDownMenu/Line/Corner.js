          ...
          <form>
            <fieldset>
              ...
              <FormControl>
                ...
                {this.state.value === 'Round' && (<><p >Sharp corners will be rounded to the specified radius.</p>
                    <div className="Input">
                    ...
                    <label className="Label">
                          <Checkbox disabled value="checkedD" style={{margin:0,padding:0,paddingLeft:'10px'}}/>Inside corner
                    </label><br/>
                    <label className="Label">
                          <Checkbox disabled checked value="checkedE"style={{margin:0,padding:0,paddingLeft:'10px'}} />Outside corner
                    </label>
<p className="TextBlock">To apply to a specific corner<br/> first ungroup the lines. </p>
                        </>)
                }
         {this.state.value==='Chamfer'&&(<><p>Sharp corners will be beveled to the specified distance.</p>
